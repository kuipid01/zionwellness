      ...
      {isLoading ? (
       ...
       /> */}
          ...
          <motion.div
            ...
            className="w-screen py-8 h-full relative z-20 bg-white "
          >
            <img
              ...
              <div className=" w-full flex md:flex-row flex-col gap-5">
                <div className="flex flex-col gap-2 items-center justify-center ">
                  ...
                  <p className="text-center font-[300] md:font-[500] text-gray-900">
                    Access healthcare and education made easy. We assist you in
                    connecting with disability-friendly healthcare providers and
                    inclusive educational opportunities. Our team is here to
                    support your journey towards equal access.
                  </p>
                </div>
                <div className="flex flex-col gap-2 items-center justify-center ">
                  <AiOutlineCheckCircle className="text-6xl text-[#801645]" />
                  <p className="text-center font-[300] md:font-[500] text-gray-900">
                    Connect you to inclusive community support. Access sports
                    clubs, groups, and charities tailored for individuals with
                    disabilities. Empowering equal opportunities and a strong
                    network.
                  </p>
                </div>
                <div className="flex flex-col gap-2 items-center justify-center ">
                  <AiOutlineCheckCircle className="text-6xl text-[#801645]" />
                  <p className="text-center font-[300] md:font-[500] text-gray-900">
                    Nurture informal supports. We offer resources to help you
                    maintain and enrich the valuable support you receive from
                    family and friends, contributing to your well-being.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="w-fit gap-[3rem] text-xl md:text-4xl md:pb-[3rem] mx-auto flex justify-between">
              <a
                target="blank"
                href="https:www.facebook.com/profile.php?id=100094282963144&mibextid=LQQJ4d"
              >
                <FaFacebook />
              </a>
              <a
                target="blank"
                href="https:instagram.com/zionsupportservices?igshid=MzRlODBiNWFlZA=="
              >
                {" "}
                <FaInstagram />
              </a>
          ...
          <motion.div className="w-screen h-full relative z-20 bg-white ">
            <div className="md:px-[90px] px-3 bg-white  w-full  p-[5px] py-14 relative mdw-[80%] mx-auto h-fit md:h-[70vh] gap-[50px] items-center flex md:flex-row flex-col-reverse justify-between">
                ...
                <p className="font-[300] flex flex-col  h-full w-fit relative  text-gray-700 text-left">
                  ...
                  <span className="md:p-4 md:text-[13px] mt-9 text-centre  lg:text-[15px]">
                    ...
                    <span className="hidden lg:flex">
                      is committed to empowering and enhancing the lives of our
                      clients. We strive to address the unique needs of each
                      individual through a range of specialized services. Let us
                      guide and assist you on your journey to better health and
                      overall wellness.
                    </span>
                  </span>
                  <Link to="/contact">
                    {" "}
                    <button className="px-8 rounded-[20px] mt-6 w-fit py-3 uppercase font-[600] bg-[#D28F40] text-white">
                      Book an appointment
                    </button>
                  </Link>
                </p>
