    ...
    <div ref={scrollToTopRef} className=" flex flex-col justify-center relative items-center w-full h-full ">
      ...
      <div className="w-full bg-white px-2 md:px-12  z-[888] h-full py-[40px] md:py-32">
        ...
        <p  className="w-full font-light text-gray-700 md:w-[1000px] leading-7 md:leading-8 ">
          ...
          <span style={textStyle} className="text-sm md:text-[20px] font-[500] text-gray-600 tracking-wider leading-[35px]" >
          ...
          <span style={textStyle} className=" md:text-[20px] text-sm font-[300] text-gray-700 tracking-wider leading-[35px]" >
          ...
          </h1>  <span style={textStyle} className="text-sm font-[300]  md:text-[20px] text-gray-700 tracking-wider leading-[35px]" >
