...
<h1 style={textStyle}  className='text-[38px] tracking-wider leading-[50px] md:text-[50px] font-[300] md:leading-[100px] md:font-[900]'>The wholesome care,   you <br className='flex md:hidden' /> deserve</h1>
