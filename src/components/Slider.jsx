...
setSlideValue(-index*100)
  ...
  return (
    <div className='w-full flex relative overflow-hidden h-[85vh]'>
...
<h1 className='text-[35px] md:text-[60px] md:leading-[100px] font-extrabold'>Your Wellness, <br className='flex md:hidden' />  Our Priority</h1>
