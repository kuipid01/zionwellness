...
const Ndis = ({type}) => {
  if (type==='choose') {
    return (
      <div className="px-3 my-[50px] md:my-[10px]  md:px-[75px] h-fit w-full md:h-[85vh] gap-5 flex md:flex-row flex-col justify-center items-center">
       <div className="flex-1 flex  justify-center items-center md:flex h-full">
        ...
        <div className="flex md:px-3 flex-1 flex-col  gap-1">
          ...
          <button className=" mt-3 w-full  hover:-translate-y-[5px] rounded-[5px]  py-3 font-semibold bg-[#D28F40] text-white   ">About Us</button>
  ...
  if (type==='disability') {
    return (
      <div className="px-3 md:px-[75px] bg-gray-100 w-full h-fit md:h-[85vh] flex md:flex-row gap-3 flex-col-reverse justify-center items-center">
        ...
        <div className="flex md:px-3 flex-1 flex-col gap-1">
          <h1 className="font-[700] text-[25px] md:text-2xl md:font-[500] text-gray-800 leading-10">Disability Support and Care Services </h1>
          ...
          <Link to='/about'>
          <button className=" mt-3 w-full mb-[100px] hover:-translate-y-[5px] rounded-[5px]  py-3 font-semibold bg-[#D28F40] text-white   ">About Us</button>
    ...
    <div className="px-3 md:px-[75px] w-full h-fit my-[40px] md:my-0 md:h-[85vh] flex justify-center items-center">
      <div className="flex md:px-3 flex-1 flex-col gap-8">
        ...
        <p className="font-bold">
          ...
          <a className="text-[#801645] ml-[3px]" href="https://www.ndis.gov.au/applying-access-ndis/am-i-eligible">
            official NDIS Eligibility Checklist.
          </a>
        </p>
        <button className=" mt-3 w-fit  hover:-translate-y-[5px] rounded-[5px]  py-2 px-7 font-semibold bg-[#D28F40] text-white  ">Disabilty Services</button>
      </div>
