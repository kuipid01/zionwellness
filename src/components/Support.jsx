const Support = () => {
  return (
    <div className="px-3 h-fit mt-30px] pb-[100px] md:pb-[1px] md:px-[75px] w-full md:h-[95vh] flex  flex-col justify-center items-center">
      <h1 className="text-[22px] text-center font-[400] leading-[40px]">
        The types of supports that the NDIS may fund for participants include:
      </h1>
      <ul className="md:w-[80%] w-full list-decimal h-fit gap-4 flex flex-col  mt-10">
        <div className="flex gap-2 items-center w-full">
          <div className="w-[12px] h-[12px] rounded-full bg-[#D28F40] "></div>
        ...
        <div  className="flex items-center">
          <div className="w-[12px] h-[12px] rounded-full bg-[#D28F40] mr-2"></div>{" "}
